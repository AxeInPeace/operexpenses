...
urlpatterns = [
	...
	url(r'^pathcard/$', views.forms_pathcard, name='save_pathcard'),
	...
	url(r'^editstart/$', views.edit_start, name="edit_start"),
	url(r'^editchoosepathcard/$', views.edit_choose_pathcard, name="edit_choose_pathcard"),
	url(r'^editpathcard/$', views.edit_pathcard, name="edit_pathcard"),
